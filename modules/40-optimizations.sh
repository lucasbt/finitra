#!/usr/bin/env bash
# =============================================================================
# modules/40-optimizations.sh -- Performance and SSD Optimizations
#
# Tasks:
#   - Kernel (sysctl): swappiness, inotify limits for IDEs, and network tuning.
#   - I/O Scheduler: SSD-optimized udev rules (NVMe/SATA) for low latency.
#   - Maintenance: SSD TRIM (fstrim) activation and journald disk usage limits.
#   - Boot/Session: NetworkManager-wait-online and GNOME Software autostart cleanup.
# =============================================================================
...
_configure_journald() {
  ...
  local conf_file="${conf_dir}/99-initora.conf"
